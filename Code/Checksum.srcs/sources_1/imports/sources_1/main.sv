...
module regFile( input logic clk, w_e, r_e_0, r_e_1,
	...
	logic [7:0] RAM [15:0] = {8'h0f, 8'h0e, 8'h0d, 8'h0c,
                              8'h0b, 8'h0a, 8'h09, 8'h08,
                              8'h07, 8'h06, 8'h05, 8'h04,
                              8'h03, 8'h02, 8'h01, 8'h00}; // initial value
    
    always_ff @(posedge clk)
        if (w_e) RAM[w_a] <= w_d; // write is always synchronous

    always_comb begin
        if (r_e_0) r_d_0 = RAM[r_a_0]; // asynchronous read
